...
public interface UserMapper extends BaseMapper<User> {
     ...
     * @return 用户列表
     */
    List<User> findByRoleId(@Param("roleId") Long roleId, Page<User> page);
    ...
    List<User> findByRoleIdAndCondition(@Param("roleId") Long roleId,
                                        @Param("user") User user, Page<User> page);
     ...
     * @return 用户列表
     */
    List<User> findByCondition( @Param("user") User user, Page<User> page);
